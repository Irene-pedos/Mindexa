...
import { Bell, Calendar, Award, AlertTriangle, CheckCheck, FileText, Users } from "lucide-react"
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your academic and administrative alerts</p>
        </div>
