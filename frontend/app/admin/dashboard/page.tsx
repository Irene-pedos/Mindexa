  ...
  const systemMetrics = [
    {
      ...
      value: data?.summary.total_students.value ?? 0,
      delta: data?.summary.total_students.delta ?? 0,
      positive: data?.summary.total_students.positive ?? true,
      lastMonth: data?.summary.total_students.last_month ?? 0,
      icon: Users,
    },
    {
      title: "Active Courses",
      value: data?.summary.active_courses.value ?? 0,
      delta: data?.summary.active_courses.delta ?? 0,
      positive: data?.summary.active_courses.positive ?? true,
      lastMonth: data?.summary.active_courses.last_month ?? 0,
      icon: BookOpen,
    },
    {
      title: "Total Lecturers",
      value: data?.summary.total_lecturers.value ?? 0,
      delta: data?.summary.total_lecturers.delta ?? 0,
      positive: data?.summary.total_lecturers.positive ?? true,
      lastMonth: data?.summary.total_lecturers.last_month ?? 0,
      icon: Users,
    },
    {
      title: "Flagged Events",
      value: data?.summary.flagged_events_today.value ?? 0,
      delta: data?.summary.flagged_events_today.delta ?? 0,
      positive: data?.summary.flagged_events_today.positive ?? true,
      lastMonth: data?.summary.flagged_events_today.last_month ?? 0,
      icon: AlertTriangle,
    },
  ];
