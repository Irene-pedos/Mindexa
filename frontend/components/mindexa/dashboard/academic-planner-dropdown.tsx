                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      hasEvent &&
                        !isCurrentToday &&
                        "text-red-500 font-medium relative after:absolute after:bottom-1 after:left-1/2 after:-translate-x-1/2 after:size-1 after:rounded-full after:bg-red-500",
                    )}
                  >
                    {day}
                  </div>
            ...
            <>
              ...
              <div>
                ...
                {todayEvents.length > 0 ? (
                  ...
                  <p className="text-sm text-muted-foreground py-4 text-center border rounded-xl border-dashed">
              ...
              <div>
                    ...
                    {upcomingEvents.map((event) => (
                      <Card key={event.id} className="p-4">
                        <div className="flex gap-3">
                          ...
                          <Badge
                            variant="outline"
                            className="self-start text-[10px] whitespace-nowrap"
                          >
                            {event.type}
                          </Badge>
                        </div>
                ...
                <Button
                  variant="outline"
                  className="w-full mt-4 text-sm hover:bg-primary hover:text-primary-foreground"
                  asChild
                >
