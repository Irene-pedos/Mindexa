...
export function GroupIntroCard({ assessment, groupName }: GroupIntroCardProps) {
  ...
  return (
    <Card className="border shadow-none overflow-hidden transition-all duration-200">
      <CardHeader 
        className="bg-primary/5 border-b py-4 cursor-pointer hover:bg-primary/[0.07] transition-colors"
              ...
              <div>
                <CardTitle className="text-xl font-bold tracking-tight flex items-center gap-2">
                  ...
                  <span className="text-xs font-normal text-muted-foreground hidden md:inline">
                    (Click header to {isCollapsed ? "expand" : "collapse"})
                  </span>
                </CardTitle>
          ...
          <div className="flex items-center gap-3 self-end md:self-auto">
             <div className="flex flex-wrap items-center gap-2">
                ...
                <Badge variant="outline" className={cn(
                  "h-7 px-3 border shadow-none text-[10px] font-bold uppercase tracking-wider",
             ...
             <div className="size-8 rounded-lg bg-background border flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent transition-colors">
      ...
      {!isCollapsed && (
        <CardContent className="p-6 animate-in fade-in slide-in-from-top-2 duration-200">
