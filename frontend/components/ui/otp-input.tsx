...
function AnimatedInputOTPSlot({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "data-[active=true]:border-ring data-[active=true]:ring-ring/50 data-[active=true]:aria-invalid:ring-destructive/20 dark:data-[active=true]:aria-invalid:ring-destructive/40 aria-invalid:border-destructive data-[active=true]:aria-invalid:border-destructive dark:bg-input/30 border-input relative flex h-11 w-11 md:h-14 md:w-14 md:text-xl items-center justify-center border-y border-r text-sm shadow-none transition-all outline-none first:rounded-l-xl first:border-l last:rounded-r-xl data-[active=true]:z-10 data-[active=true]:ring-2",
        className
      )}
    ...
    >
      ...
      {hasFakeCaret && (
        ...
        >
          <motion.div
            className="bg-foreground h-4 w-px md:h-6"
