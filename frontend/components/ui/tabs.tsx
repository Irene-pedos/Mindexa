...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-xl bg-muted/40 p-1 text-muted-foreground gap-1 border-none",
      className,
    )}
    {...props}
  />
