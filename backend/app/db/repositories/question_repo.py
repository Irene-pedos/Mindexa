    ...
    async def create(
        ...
        *,
        ...
        question = Question(
            ...
            content=content,
            case_study_context=case_study_context,
            image_url=image_url,
            ...
            topic_tag=topic_tag,
            rubric_id=rubric_id,
            question_table_context=question_table_context,
            requires_table_answer=requires_table_answer,
            answer_table_template=answer_table_template,
