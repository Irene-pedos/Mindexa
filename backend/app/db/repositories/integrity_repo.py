        ...
        defaults = [
            {
                ...
                "description": "Low strictness for formative self-assessment practice. Students can freely switch tabs, copy/paste, and blur screen with zero warnings.",
                "is_default": False,
                "allow_resume": True,
                "rules_json": {
                    "tab_switching": {"category": "Tolerated", "action": "IGNORE"},
                    "window_minimize": {"category": "Tolerated", "action": "IGNORE"},
                    ...
                    "screen_blurring": {"category": "Tolerated", "action": "IGNORE"},
                    "browser_refresh": {"category": "Tolerated", "action": "IGNORE"},
                    "closing_browser": {"category": "Tolerated", "action": "LOG_ONLY"},
                    "opening_another_device": {"category": "Tolerated", "action": "LOG_ONLY"},
                    "multiple_sessions": {"category": "Tolerated", "action": "LOG_ONLY"},
                    "unauthorized_sharing": {"category": "Tolerated", "action": "IGNORE"},
            ...
            },
            {
                ...
                "description": "Open rules for take-home coursework. Student is free to switch tabs, copy/paste, and blur screen with zero warnings.",
                "is_default": False,
                "allow_resume": True,
                "rules_json": {
                    "tab_switching": {"category": "Tolerated", "action": "IGNORE"},
