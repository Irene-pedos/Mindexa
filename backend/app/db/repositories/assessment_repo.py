    ...
    async def create(
        ...
        *,
        ...
        assessment = Assessment(
            ...
            peer_evaluation_enabled=peer_evaluation_enabled,
            peer_evaluation_deadline=peer_evaluation_deadline,
            peer_evaluation_weight_percent=peer_evaluation_weight_percent,
            individual_weighting_enabled=individual_weighting_enabled,
