...
from app.db.enums import (AIQuestionDecision, DifficultyLevel,
...
class QuestionOptionCreate(MindexaSchema):
    ...
    match_key: Optional[str] = Field(default=None, max_length=500)
    match_value: Optional[str] = Field(default=None, max_length=500)
...
class QuestionCreate(MindexaSchema):
    ...
    topic_tag: Optional[str] = Field(default=None, max_length=100)
...
class QuestionUpdate(MindexaSchema):
    ...
    content: Optional[str] = Field(default=None, min_length=5, max_length=5000)
    explanation: Optional[str] = Field(default=None, max_length=2000)
    ...
    blanks: Optional[List[QuestionBlankCreate]] = None
...
class AddQuestionToAssessmentRequest(MindexaSchema):
    ...
    order_index: int = Field(ge=0)
    marks_override: Optional[int] = Field(default=None, ge=1, le=100)
...
class AssessmentQuestionResponse(BaseAuditedResponse):
    ...
    question_id: uuid.UUID
    assessment_section_id: Optional[uuid.UUID]
    order_index: int
    marks_override: Optional[int]
    is_required: bool
    added_via: str
    question: Optional[QuestionSummaryResponse] = None
...
class AIGenerationRequest(MindexaSchema):
    ...
    custom_prompt_hint: Optional[str] = Field(default=None, max_length=500)
...
class AIQuestionReviewDecision(MindexaSchema):
    ...
    modification_summary: Optional[str] = Field(default=None, max_length=500)
    add_to_assessment: bool = False
    add_to_bank: bool = False

    # If decision is ACCEPTED or MODIFIED, the modified content (if any)
    updated_content: Optional[str] = Field(default=None, max_length=5000)
    updated_explanation: Optional[str] = Field(default=None, max_length=2000)
    updated_marks: Optional[int] = Field(default=None, ge=1, le=100)
...
class AIQuestionReviewResponse(BaseAuditedResponse):
    ...
    added_to_bank: bool
    question: Optional[QuestionDetailResponse] = None
